...
// version-5614147a439b4ead
// dumped by moon (discord.gg/skids <- pls join)

namespace offsets {
    inline constexpr const char* roblox_version = "version-5614147a439b4ead";

    namespace VisualEngine {
        inline constexpr uintptr_t ViewMatrix = 0x130;
        inline constexpr uintptr_t RenderView = 0xb40;
        inline constexpr uintptr_t Pointer = 0x74d9c50;
    ...
    namespace FFlag {
        inline constexpr uintptr_t PhysicsSenderMaxBandwidthBps = 0x6dc0df4;
        inline constexpr uintptr_t TaskSchedulerTargetFps = 0x72323b4;
        inline constexpr uintptr_t DebugDisableTimeoutDisconnect = 0x72d01b8;
        inline constexpr uintptr_t WebSocketServiceEnableClientCreation = 0x72fd3d8;
        inline constexpr uintptr_t EnableLoadModule = 0x72b23e8;
        inline constexpr uintptr_t DebugSkyGray = 0x7273e78;
        inline constexpr uintptr_t PartyPlayerInactivityTimeoutInSeconds = 0x6dc0930;
    }
    ...
    namespace FakeDataModel {
        inline constexpr uintptr_t Pointer = 0x7923298;
