...
// version-a315195b40e84be3
// dumped by moon (discord.gg/skids <- pls join)

namespace offsets {
    inline constexpr const char* roblox_version = "version-a315195b40e84be3";

    namespace VisualEngine {
        inline constexpr uintptr_t ViewMatrix = 0x130;
        inline constexpr uintptr_t RenderView = 0xb40;
        inline constexpr uintptr_t Pointer = 0x780c420;
    ...
    namespace Humanoid {
        ...
        inline constexpr uintptr_t AutoJumpEnabled = 0xdd;
    ...
    namespace DragDetector {
        inline constexpr uintptr_t Enabled = 0xf5;
        inline constexpr uintptr_t RunLocally = 0xed;
    ...
    namespace FFlag {
        inline constexpr uintptr_t TaskSchedulerTargetFps = 0x75617b4;
        inline constexpr uintptr_t PhysicsSenderMaxBandwidthBps = 0x70e7e3c;
        inline constexpr uintptr_t DebugDisableTimeoutDisconnect = 0x7603608;
        inline constexpr uintptr_t EnableLoadModule = 0x75e63a8;
        inline constexpr uintptr_t PhysicsSenderMaxBandwidthBpsScaling = 0x70e7e44;
        inline constexpr uintptr_t DebugSkyGray = 0x75a2ad8;
        inline constexpr uintptr_t PartyPlayerInactivityTimeoutInSeconds = 0x70e7934;
        inline constexpr uintptr_t NextGenReplicatorEnabledWrite4 = 0x76a89f8;
    }
    ...
    namespace FakeDataModel {
        inline constexpr uintptr_t Pointer = 0x7c5f408;
