...
// version-d813c9bad18d4a16
// dumped by moon (discord.gg/skids <- pls join)

namespace offsets {
    inline constexpr const char* roblox_version = "version-d813c9bad18d4a16";

    namespace VisualEngine {
        inline constexpr uintptr_t ViewMatrix = 0x130;
        inline constexpr uintptr_t RenderView = 0xb70;
        inline constexpr uintptr_t Pointer = 0x77c66f0;
    ...
    namespace FFlag {
        inline constexpr uintptr_t TaskSchedulerTargetFps = 0x751a794;
        inline constexpr uintptr_t PhysicsSenderMaxBandwidthBps = 0x709ce4c;
        inline constexpr uintptr_t DebugDisableTimeoutDisconnect = 0x75bd1c8;
        inline constexpr uintptr_t EnableLoadModule = 0x75a0b18;
        inline constexpr uintptr_t PhysicsSenderMaxBandwidthBpsScaling = 0x709ce50;
        inline constexpr uintptr_t DebugSkyGray = 0x755bc28;
        inline constexpr uintptr_t PartyPlayerInactivityTimeoutInSeconds = 0x709c934;
        inline constexpr uintptr_t NextGenReplicatorEnabledWrite4 = 0x7662ae8;
    }
    ...
    namespace FakeDataModel {
        inline constexpr uintptr_t Pointer = 0x7c1a158;
