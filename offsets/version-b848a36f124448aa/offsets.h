...
// version-b848a36f124448aa
// dumped by moon (discord.gg/skids <- pls join)

namespace offsets {
    inline constexpr const char* roblox_version = "version-b848a36f124448aa";
    ...
    namespace World {
        ...
        inline constexpr uintptr_t Primitives = 0x208;
    }
    ...
    namespace FFlag {
        inline constexpr uintptr_t PhysicsSenderMaxBandwidthBps = 0x6d74dfc;
        inline constexpr uintptr_t TaskSchedulerTargetFps = 0x7ae3364;
        inline constexpr uintptr_t DebugDisableTimeoutDisconnect = 0x7b80388;
        inline constexpr uintptr_t WebSocketServiceEnableClientCreation = 0x7bac6d8;
        inline constexpr uintptr_t EnableLoadModule = 0x7b61708;
        inline constexpr uintptr_t DebugSkyGray = 0x7b24cb0;
        inline constexpr uintptr_t PartyPlayerInactivityTimeoutInSeconds = 0x6d74938;
    }
    ...
    namespace FakeDataModel {
        inline constexpr uintptr_t Pointer = 0x81d3cf8;
