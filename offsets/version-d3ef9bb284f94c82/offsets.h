...
// version-d3ef9bb284f94c82
// dumped by moon (discord.gg/skids <- pls join)

namespace offsets {
    inline constexpr const char* roblox_version = "version-d3ef9bb284f94c82";

    namespace VisualEngine {
        inline constexpr uintptr_t ViewMatrix = 0x130;
        inline constexpr uintptr_t RenderView = 0xb40;
        inline constexpr uintptr_t Pointer = 0x7577268;
    ...
    namespace VectorForce {
        inline constexpr uintptr_t ApplyAtCenterOfMass = 0x14e;
    ...
    namespace Terrain {
        ...
        inline constexpr uintptr_t WaterTransparency = 0x108;
    ...
    namespace FFlag {
        inline constexpr uintptr_t PhysicsSenderMaxBandwidthBps = 0x6e5adfc;
        inline constexpr uintptr_t TaskSchedulerTargetFps = 0x72ce858;
        inline constexpr uintptr_t DebugDisableTimeoutDisconnect = 0x736e068;
        inline constexpr uintptr_t EnableLoadModule = 0x73502f8;
        inline constexpr uintptr_t PhysicsSenderMaxBandwidthBpsScaling = 0x6e5adf4;
        inline constexpr uintptr_t DebugSkyGray = 0x73109c8;
        inline constexpr uintptr_t PartyPlayerInactivityTimeoutInSeconds = 0x6e5a93c;
        inline constexpr uintptr_t NextGenReplicatorEnabledWrite4 = 0x75a1148;
    }

    namespace Camera {
        inline constexpr uintptr_t DiagonalFieldOfView = 0x3e;
        inline constexpr uintptr_t MaxAxisFieldOfView = 0x3e;
    ...
    namespace FakeDataModel {
        inline constexpr uintptr_t Pointer = 0x79c8578;
