...
// version-b3b521ca983141f3
namespace offsets {
    inline constexpr const char* roblox_version = "version-b3b521ca983141f3";

    namespace VisualEngine {
        inline constexpr uintptr_t ViewMatrix = 0x140;
        inline constexpr uintptr_t RenderView = 0xb50;
        inline constexpr uintptr_t Pointer = 0x7d77fc8;
    ...
    namespace FFlag {
        inline constexpr uintptr_t PhysicsSenderMaxBandwidthBps = 0x6d65e0c;
        inline constexpr uintptr_t TaskSchedulerTargetFps = 0x7ad3108;
        inline constexpr uintptr_t DebugDisableTimeoutDisconnect = 0x7b6fdd8;
        inline constexpr uintptr_t WebSocketServiceEnableClientCreation = 0x7b9b688;
        inline constexpr uintptr_t EnableLoadModule = 0x7b51978;
        inline constexpr uintptr_t DebugSkyGray = 0x7b14a50;
        inline constexpr uintptr_t PartyPlayerInactivityTimeoutInSeconds = 0x6d65934;
    }
    ...
    namespace FakeDataModel {
        inline constexpr uintptr_t Pointer = 0x81c2b08;
