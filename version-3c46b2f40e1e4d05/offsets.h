...
// version-3c46b2f40e1e4d05
// dumped by moon (discord.gg/skids <- pls join)

namespace offsets {
    inline constexpr const char* roblox_version = "version-3c46b2f40e1e4d05";

    namespace VisualEngine {
        inline constexpr uintptr_t ViewMatrix = 0x130;
        inline constexpr uintptr_t RenderView = 0xb40;
        inline constexpr uintptr_t Pointer = 0x750f900;
    ...
    namespace DragDetector {
        inline constexpr uintptr_t Enabled = 0x18d;
        inline constexpr uintptr_t RunLocally = 0xf5;
    ...
    namespace FFlag {
        inline constexpr uintptr_t PhysicsSenderMaxBandwidthBps = 0x6df6df4;
        inline constexpr uintptr_t TaskSchedulerTargetFps = 0x72682b4;
        inline constexpr uintptr_t DebugDisableTimeoutDisconnect = 0x7305e68;
        inline constexpr uintptr_t WebSocketServiceEnableClientCreation = 0x7333088;
        inline constexpr uintptr_t EnableLoadModule = 0x72e8098;
        inline constexpr uintptr_t DebugSkyGray = 0x72a9b28;
        inline constexpr uintptr_t PartyPlayerInactivityTimeoutInSeconds = 0x6df6930;
    }
    ...
    namespace FakeDataModel {
        inline constexpr uintptr_t Pointer = 0x7958f38;
